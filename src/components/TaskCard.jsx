  ...
  return (
    ...
    >
      ...
      <div className="mt-3 flex flex-col gap-2">
        <button
          type="button"
          className="w-full rounded-xl bg-blue-500 px-3 py-2 text-xs font-medium text-white transition hover:bg-blue-600"
        ...
        <button
          type="button"
          className="w-full rounded-xl bg-white px-3 py-2 text-xs font-medium text-red-600 transition hover:bg-red-100"
